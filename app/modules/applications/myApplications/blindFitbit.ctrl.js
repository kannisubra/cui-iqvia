...
.controller('blindFitbitCtrl', function(API,APIError,APIHelpers,DataStorage,Loader,User,$filter,$pagination,$q,$scope,$state,$stateParams,$http) {
    ...
    API.cui.getUsersHeartRateHistory({'qs':[['sortBy','-creation'],['eventTemplateId','ef6928b8-cd4e-43c8-8862-71f5dbae1137']]})
        .then(res=>{
            ...
            console.log("blindFitbit"+myApplications.heartRate[0].datapoints[0].value);
        }).fail(err=>{
            console.log(err);  
        }) 
